...
def generate_password():
 try:
   ...
   messagebox.showerror(message="Enter required inputs")
   return
...
password_gen.title("Devss Password Generator")
title_label = Label(password_gen, text="Devss Password Generator", font=('Ubuntu Mono',12))
title_label.pack()
length_label = Label(password_gen, text="Enter your required length: ")
